...
Device::ListOfEnabledFeatures OpenXRDevice::collectEnabledFeatures()
{
    ...
    // The spec used a estimated height if we don't provide a floor transform.
    features.append(ReferenceSpaceType::LocalFloor);

    // FIXME: Enable BoundedFloor when whe implement xrGetReferenceSpaceBoundsRect and the related bits in the DOM.
